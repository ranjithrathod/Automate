...
public class TestOnGymTime {
	...
	public void loginPage() throws InterruptedException {
		driver.get("http://103.87.174.75:8013/Frm_Login.aspx");
 ...
 /*       String month =dobMonthYear;
	...
	Thread.sleep(1000);
		...
		GymTimeAddEnquiryPage.address_Textbox(driver).sendKeys(Address);
	...
	//	GymTimeAddEnquiryPage.occupation_Dropdown(driver).sendKeys(Keys.TAB);
		...
		GymTimeAddEnquiryPage.referBy_Textbox(driver).sendKeys(ReferBy);
	...
	//--------> 	Thread.sleep(1000);
		GymTimeAddEnquiryPage.budget_Textbox(driver).sendKeys(Budget);
